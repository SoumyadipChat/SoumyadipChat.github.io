...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
            ...
            var ModalCompComponent = /** @class */ (function () {
                ...
                ModalCompComponent.prototype.ngOnInit = function () {
                    ...
                    this.youtube.search(this.data.search).subscribe(function (searchList) {
                        ...
                        _this.titleText = _this.searchResults[0].title.split('|')[0].substring(0, 30);
                ...
                ModalCompComponent.prototype.updateSelection = function () {
                ...
                ModalCompComponent.prototype.updateTitle = function () {
                ...
                MusicPlayerComponent.prototype.ngAfterViewInit = function () {
                    ...
                    if (localStorage.getItem('loggedIn') !== null) {
                        ...
                        if (this.loggedInUser != 'Guest') {
                            ...
                            var lastPlaylist_1 = JSON.parse(localStorage.getItem('playlist'));
                            var lastIndexId_1 = JSON.parse(localStorage.getItem('lastIndex'));
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PlayerComponent = /** @class */ (function () {
                ...
                PlayerComponent.prototype.savePlayer = function (player) {
                    ...
                    setTimeout(function () {
                        if (_this.playerQueue.length == 0) {
                            ...
                            _this.OnIndChanges();
                            _this.player.loadVideoById(_this.playerQueue[0].videoId);
                            _this.pause();
                ...
                PlayerComponent.prototype.swipeup = function () {
                    if (this.largePlayer) {
                        this.largePlayerChange();
                    }
                };
